...
find-cims-in-tracks:
	wget https://www.agalera.eu/100cims/data/100cims/cims.json -O /tmp/100cims.json
	wget https://www.agalera.eu/100cims/data/mendikat/cims.json -O /tmp/mendikat.json
	cp out-of-sync-gpx/* gpx/.
